"""
Tests for rules package_info metadata.
"""

from cartography.rules import package_info


class TestRulesPackageInfo:

    def test_package_name(self):
        assert package_info.PACKAGE_NAME == "cartography-rules"
    ...
    def test_entry_points(self):
        ...
        assert any("cartography-rules" in s for s in scripts)
